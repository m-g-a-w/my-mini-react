(function (global, factory) {
  ...
  function insertOrAppendPlacementNodeIntoContainer(finishedWork, hostParent, before) {
      ...
      if (finishedWork.tag === HostComponent || finishedWork.tag === HostText) {
          // 检查节点是否已经在DOM中
          if (finishedWork.stateNode && finishedWork.stateNode.parentNode === hostParent) {
              return; // 如果已经在正确的父节点中，跳过插入
          }
          // 防止循环引用：检查节点是否包含父节点
          if (finishedWork.stateNode && hostParent.contains(finishedWork.stateNode)) {
              {
                  console.warn('检测到循环引用，跳过插入', finishedWork.stateNode, hostParent);
              }
              return;
          }
          if (before) {
